package com.coyoal.zsc.cnode.utils

import com.coyoal.zsc.cnode.constant.TimeConstants
...
object TimeUtils {
    ...
    private val ISO_FORMAT = SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'.'SSS'Z'", Locale.getDefault())

    fun isodate2String(isodate: String): String {
        try {
            return date2String(ISO_FORMAT.parse(isodate))
